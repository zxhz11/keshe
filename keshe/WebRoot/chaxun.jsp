...
<div style="background-color:#CCFFFF; height:100%;" class="py-5 ">
            ...
            <div class="row ">
                ...
                <div class="col-10 bg-white">
                    <div class="text-center border-bottom py-3 font-weight-bold">车票信息查询</div>
                    <div class="py-3">
                        <form action="" method="post">
                                       始发站：<input type="text" name="start"> 终点站：<input type="text" name="end"> 有效日期：<input type="text" name="date"> <input type="submit" value="查询" class="btn btn-primary">
                        </form>
                        
                        <table class="table table-bordered">
                         <thead class="table-primary">
                            <tr><th>车次</th><th>始发站</th><th>终点站</th><th>发车时间</th><th>价格</th><th>座位号</th><th>车票类型</th><th>有效日期</th><th>操作</th></tr>
                         </thead>
                         <tbody>
                        <%
                          request.setCharacterEncoding("UTF-8");
                          ...
                          String sql="select * from chepiao where start='"+start+"' and end='"+end+"' and date='"+date+"'";
                         ...
                         <tr>
                             ...
                             <td><a href="gouwu.jsp?a=<%=id%>&b=<%=username %>">订票</a></td>
                         </tr>
                        <%
                             }
                             stat.close();
